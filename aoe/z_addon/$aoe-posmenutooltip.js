...
(function(){
	var alias0 = AoeItemDamageUse.posMenuArtist.initialize;
	AoeItemDamageUse.posMenuArtist.initialize = function() {
		...
		return alias0.call(this);		
	};

	var alias1 = AoeItemDamageUse.posMenuArtist.draw;
	AoeItemDamageUse.posMenuArtist.draw = function(item, unit, targetUnit) {
		...
		return alias1.call(this, item, unit, targetUnit)
	};
